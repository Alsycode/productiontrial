...
function BlogDetails1({blogData}) {
...
export async function getServerSideProps() {
	...
	const apiUrl = "https://aecstrapi-askn4.ondigitalocean.app/api/blogcontents?populate=*&filters[slug][$eq]=the-ultimate-guide-to-healthy-meal-prep-for-busy-professionals";
