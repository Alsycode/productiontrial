...
function ProductDetails({ serviceData, otherData }) {
     const largeImageUrl =
      serviceData.data[0].attributes.serviceimage.data.attributes.formats.thumbnail.url;
...
const [currentPage, setCurrentPage] = useState(1);
 ...
 console.log("656565655655",slug)
   ...
   const totalPages = Math.ceil(filteredProducts.length / itemsPerPage);
    ...
    const product = serviceData.data[0].attributes.name;
          ...
          <div className="row" style={{ paddingTop: "30px" }}>
            <div className="col-xl-8 col-lg-8 m-b50">
              <div className="dlab-blog blog-single style-1">
                ...
                <h2>{product}</h2>
                <h2>{serviceData.data[0].attributes.date}</h2>
                <p>
            ...
            <div className="col-xl-4 col-lg-4 m-b50">
              ...
              <div className="widget recent-posts-entry">
                <h2 className="widget-title">Other services</h2>
                      ...
                      <div className="widget-post clearfix" key={product.id}>
                        <div className="dlab-media">
                          <Image
                            ...
                            height={270}
                            src={
                              product.attributes.serviceimage.data.attributes.formats
                                .thumbnail.url
                            }
...
export async function getServerSideProps(context) {
  ...
  const slugg = params.service || ""; 

  const apiUrl1 = `https://aecstrapi-askn4.ondigitalocean.app/api/services?populate=*&filters[slug][$eq]=${slugg}`;
  const apiUrl2 = `https://aecstrapi-askn4.ondigitalocean.app/api/services?populate=*`;
  const bearerToken =
